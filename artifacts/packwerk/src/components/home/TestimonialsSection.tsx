...
const REVIEWS = [
  ...
  },
  {
    ...
    company: "Happilo",
    city: "Bengaluru",
    industry: "D2C Dry Fruits & Snacks",
    stars: 5,
    text: "We cut our vendor coordination time by 80% in the first quarter. Packworkz handles everything — sourcing, QC, dispatch tracking. Our team finally has time to focus on growth, not packaging follow-ups.",
    metric: "80% less vendor coordination time",
  },
  {
    name: "Prashant Kumar",
    ...
    company: "Bodycraft",
    city: "Bengaluru",
    industry: "Fitness & Wellness D2C",
    stars: 5,
    text: "Switched all 12 of our packaging SKUs to Packworkz after our previous vendor failed us three times in a row. Six months in — zero delays, costs down 19%, and I sleep better on launch days.",
    metric: "12 SKUs · 0 delays · 19% cost reduction",
  },
  {
    name: "Dr. Shalini Bhat",
    role: "Operations Director",
    company: "Oliva Clinics",
    city: "Hyderabad",
    industry: "Dermatology & Skincare",
    stars: 5,
    text: "Our export buyer needed FSC certified packaging with full chain-of-custody documentation. Packworkz had it sourced, certified, and shipped in 14 days. No other vendor even understood the brief.",
    metric: "14-day certified export delivery",
  },
  {
    name: "Kavitha Reddy",
    role: "CEO",
