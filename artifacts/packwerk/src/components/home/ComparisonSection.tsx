      ...
      <div className="relative" style={{ zIndex: 1, maxWidth: 940, margin: "0 auto", padding: "0 24px" }}>
        ...
        <div style={{ maxWidth: 860, margin: "0 auto", display: "flex", flexDirection: "column", gap: 6 }}>
          {([
            ...
            { feature: "Product coverage",     good: "35 focused buying families, plus a managed route for specialist production.", bad: "Specialised in one category. Source the rest yourself." },
