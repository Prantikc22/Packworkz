...
const INDUSTRIES = [
  ...
  },
  {
    ...
    desc: "Barrier pouches, stand-up packs, spout packs, and food-safe films designed to extend shelf life and drive impulse purchase.",
...
// ─── Comparison ───────────────────────────────────────────────────────────────
const COMPARE = [
  { aspect: "Pricing turnaround",   old: "3–7 days",                     pw: "48 hours" },
      ...
      <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", background: "#ffffff", overflowX: "hidden" }}>
        ...
        <header style={{
          ...
          <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
            ...
            <Link href="/configure" className="lp-cta-primary" style={{ padding: "8px 18px", fontSize: 13 }}>
              Start Configuration
            </Link>
          </div>
        </header>
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto", padding: "60px 32px", width: "100%", position: "relative", zIndex: 10 }}>
            <div style={{ maxWidth: 640 }}>
              ...
              <div className="lp-cta-row" style={{
                ...
                <Link href="/configure" className="lp-cta-primary">
                  Start Configuration →
                </Link>
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto" }}>
            ...
            >
              ...
              <div style={{ background: "white", padding: "44px 44px" }}>
                ...
                <Link href="/configure" className="lp-cta-primary" style={{ width: "100%", textAlign: "center" }}>
                  Build a Packaging Plan for {ind.label} →
                </Link>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div style={{ maxWidth: 1100, margin: "0 auto", position: "relative", zIndex: 1 }}>
            ...
            <div style={{ textAlign: "center", marginTop: 56 }}>
              <Link href="/configure" className="lp-cta-primary" style={{ fontSize: 16, padding: "18px 48px" }}>
            ...
            >
              <div className="lp-calc-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr" }}>
                ...
                <div style={{ background: "#020817", padding: "44px 44px", display: "flex", flexDirection: "column", justifyContent: "center" }}>
                  ...
                  <Link href="/configure" className="lp-cta-primary" style={{ textAlign: "center" }}>
        ...
        >
          ...
          >
            <div style={{
              ...
              <span style={{ color: "rgba(255,255,255,0.8)", fontSize: 12, fontWeight: 700 }}>Pricing Plans delivered in 48 hours</span>
            </div>
            ...
            <div className="lp-cta-row" style={{ display: "flex", gap: 16, justifyContent: "center", flexWrap: "wrap" }}>
              <Link href="/configure" className="lp-cta-primary" style={{ fontSize: 16, padding: "18px 44px" }}>
                Start Configuration →
              </Link>
        ...
        <footer style={{ background: "#020817", padding: "28px 32px", borderTop: "1px solid rgba(255,255,255,0.05)" }}>
          <div style={{ maxWidth: 1100, margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 12 }}>
            ...
            <div style={{ display: "flex", gap: 24 }}>
              ...
              <Link href="/configure" style={{ color: "rgba(255,255,255,0.4)", fontSize: 13, textDecoration: "none" }}>Start Configuration</Link>
