...
globalThis.__dirname = __bannerPath.dirname(globalThis.__filename);
  ...
  // CJS build of app.ts → dist/app.cjs
  // Used by Vercel serverless function (api/index.js) which Vercel's bundler
  // always runs as CommonJS — require() cannot load .mjs files.
  await esbuild({
